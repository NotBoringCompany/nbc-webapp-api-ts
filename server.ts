...
export const ALLOWED_ORIGINS = ['http://localhost:3000', 'https://webapp.nbcompany.io', 'nbc-webapp-git-dev-not-boring-company.vercel.app'] //localhost and dev link only temporary
